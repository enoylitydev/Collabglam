...
import { Mail, Globe, Download, ExternalLink, Info } from 'lucide-react';
...
export const ContactSection: React.FC<ContactSectionProps> = ({
  ...
  const hasAnyContact =
    Boolean(mediaKit?.email) ||
    Boolean(mediaKit?.website) ||
    Boolean(mediaKit?.mediaKitPdf);
            ...
            {!hasAnyContact ? (
              ...
              <>
                  ...
                  {mediaKit.email && (
                    ...
                    >
                      <a
                        ...
                        aria-label="Email the influencer"
                      >
                ...
                {mediaKit.website && (
                  ...
                  >
                    <a
                      href={withHttp(mediaKit.website)}
                      target="_blank"
                      rel="noopener noreferrer"
