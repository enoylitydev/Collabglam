...
import {
  ...
  FileText, DollarSign, Link as LinkIcon, Languages,
  Heart, MessageCircle, Eye, TrendingUp, Users, CheckCircle2, ExternalLink,
  Award, Zap, Target, Activity
} from "lucide-react";
...
export default function MediaKitPage({ influencerId: propId }: { influencerId?: string }) {
  ...
  // Platform selector state (brand/read-only view)
  ...
  // Primary profile for current selection
