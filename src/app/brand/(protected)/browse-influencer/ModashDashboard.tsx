...
export default function ModashDashboard() {
  ...
  const onViewProfile = useCallback(
    (influencer: any) => {
      ...
      // ⬇️ initial report load (cache-friendly)
  ...
  // ⬇️ used by DetailPanel "Refresh data" button
  const handleRefreshReport = useCallback(async () => {
    ...
    await fetchReport(
      ...
      selectedPlatform,
      calculationMethod,
      undefined, // influencerId if you have it
      true       // forceRefresh → bypass cache + update DB + lastFetchedAt
    );
