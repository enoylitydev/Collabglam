...
// ✅ make sure this is a proper path
...
const badgeClass = (status: string) => {
    ...
    if (s === "revision") return "bg-blue-100 text-blue-700 border-blue-200";
                            ...
                            {rows.map((d) => {
                                ...
                                return (
                                    <tr key={d._id} className="hover:bg-gray-50/60">
                                        ...
                                        <td className="px-4 py-3 text-gray-700">{formatDateTime(d.createdAt)}</td>
                                        ...
                                        <td className="px-4 py-3">
                                            ...
                                            <div className="flex flex-col gap-2">
                                                ...
                                                <Button
                                                    ...
                                                    // ✅ lock Revision after approve too
