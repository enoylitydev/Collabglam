  ...
  return (
    <div className="space-y-3">
      ...
      {items.length > 0 && (
        <div className="flex flex-wrap gap-2.5">
          {items.map((item, i) => (
            <span
              key={`${item}-${i}`}
              className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-medium bg-gradient-to-r from-orange-100 to-orange-50 border border-orange-200 text-gray-700"
            >
              {item}
              <button
                type="button"
              ...
              >
                <HiTrash className="w-3.5 h-3.5 text-gray-600" />
              </button>
            </span>
          ))}
        </div>
      ...
      <div className="flex gap-2">
        <input
          className="flex-1 px-4 py-3 border-2 border-gray-200 rounded-lg text-sm transition-all duration-200 focus:border-[#FFA135] focus:outline-none"
        ...
        <button
          type="button"
          onClick={add}
          className="px-4 py-3 rounded-lg bg-gradient-to-br from-[#FFA135] to-[#FF7236] text-white font-medium transition-all duration-200 hover:shadow-lg hover:scale-105"
          title="Add"
        >
